...
export type HiddenProps<TTag extends ElementType> = Props<
	TTag,
	{},
	never,
	{ features?: Features }
...
>(props: HiddenProps<TTag>, ref: Ref<HTMLElement>) {
...
export let Hidden = forwardRefWithAs(
	VisuallyHidden
) as unknown as ComponentHidden;
